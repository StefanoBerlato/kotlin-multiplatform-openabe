      ...
      struct {
        struct {
          struct {
            ...
            libmultiplatform_crypto_libopenabe_bindings_KBoolean (*isLibraryLoadedYet)(libmultiplatform_crypto_libopenabe_bindings_kref_it_stefanoberlato_LibopenabeInitializer thiz);
            libmultiplatform_crypto_libopenabe_bindings_KBoolean (*isPlatformInitializedYet)(libmultiplatform_crypto_libopenabe_bindings_kref_it_stefanoberlato_LibopenabeInitializer thiz);
          ...
          struct {
            ...
            struct {
              ...
              const char* (*freeAndReturn)(libmultiplatform_crypto_libopenabe_bindings_kref_it_stefanoberlato_oabe_LibopenabeUtil thiz, void* pointer);
